...
python main.py  --test_domain c --dataroot ".\data\DomainNet\\" --dataset minidomainnet --labeled_ratio 0.3 --communication_rounds 100 --client_epoch 1 --client_gm Delta --workers 0 --aggregation AbyA 
